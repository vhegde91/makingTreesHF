...
config.General.requestName = 'HFTree25nsMC_v2_2400to3200'
config.General.workArea = 'crab25nsMC_v2_2400to3200'
...
config.Data.outputDatasetTag = 'CRAB3_HFTree25nsMC_v2_2400to3200'
