...
config.General.requestName = 'HFTree25nsMC_v2_470to600'
config.General.workArea = 'crab25nsMC_v2_470to600'
...
config.Data.outputDatasetTag = 'CRAB3_HFTree25nsMC_v2_470to600'
