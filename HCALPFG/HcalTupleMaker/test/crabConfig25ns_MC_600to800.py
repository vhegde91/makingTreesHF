...
config.General.requestName = 'HFTree25nsMC_v2_600to800'
config.General.workArea = 'crab25nsMC_v2_600to800'
...
config.Data.outputDatasetTag = 'CRAB3_HFTree25nsMC_v2_600to800'
