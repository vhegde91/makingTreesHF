...
config.General.requestName = 'HFTree25nsMC_v2_3200toInf'
config.General.workArea = 'crab25nsMC_v2_3200toInf'
...
config.Data.outputDatasetTag = 'CRAB3_HFTree25nsMC_v2_3200toInf'
