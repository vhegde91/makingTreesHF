...
config.General.requestName = 'HFTree25nsMC_v2_800to1000'
config.General.workArea = 'crab25nsMC_v2_800to1000'
...
config.Data.outputDatasetTag = 'CRAB3_HFTree25nsMC_v2_800to1000'
