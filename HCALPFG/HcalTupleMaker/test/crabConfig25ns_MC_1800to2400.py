...
config.General.requestName = 'HFTree25nsMC_v2_1800to2400'
config.General.workArea = 'crab25nsMC_v2_1800to2400'
...
config.Data.outputDatasetTag = 'CRAB3_HFTree25nsMC_v2_1800to2400'
